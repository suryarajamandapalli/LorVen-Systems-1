...
function EmsRoute() {
  ...
  const capabilities = [
    {
      ...
      bullets: [
        ...
        "Precision component placement for multi-layer PCBs and safety-critical modules.",
        "Workmanship compliant with IPC-A-610 standards."
      ]
    },
    {
      num: "02",
      title: "Box-Build & Harness Integration",
      bullets: [
        "Box-build and cable/harness assembly.",
        "Complete sub-system enclosure integration for railway rolling stock and wayside units.",
        "100% cable continuity and insulation verification."
      ]
    },
    {
      num: "03",
      ...
      bullets: [
        ...
        "Automated Optical Inspection (AOI) and multi-stage quality checks.",
        "Custom test-jigs and functional acceptance verification."
      ]
    },
    {
      num: "04",
      ...
      bullets: [
        ...
        "Lot-level component tracking and supplier verification.",
        "Adherence to railway Quality Assurance Plans (QAP)."
      ]
    }
  ];
  ...
  const whyLorVen = [
    {
      title: "Hyderabad Manufacturing Facility",
      desc: "In-house SMT and through-hole assembly facility engineered for high-reliability railway electronics."
    },
    {
      title: "IPC-A-610 Workmanship",
      desc: "Strict adherence to IPC-A-610 assembly, soldering, and inspection standards."
    },
    {
      title: "In-Circuit & Functional Testing",
      desc: "Comprehensive testing protocols including ICT, functional testing, and stress screening before shipment."
    },
    {
      title: "Full Material Traceability",
      desc: "ISO 9001:2015-aligned QMS with complete lot-level component traceability and QAP compliance."
    }
  ];
    ...
    <div ref={containerRef} className="bg-bg text-ink selection:bg-ink selection:text-on-dark antialiased">
      ...
      <section className="relative min-h-screen bg-ink overflow-hidden flex flex-col justify-center pb-20 pt-28">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <img
            src={smtLine}
            alt="Electronics Manufacturing Services SMT Line"
          ...
          <div className="max-w-4xl space-y-5">
            ...
            <nav className="text-xs uppercase tracking-wider text-white/50">
              <ol className="flex items-center gap-2 flex-wrap font-semibold">
                ...
                <li className="text-white/20 font-light">&gt;</li>
                <li className="text-white">Electronics Manufacturing Services</li>
              </ol>
            </nav>
            ...
            <p className="text-base md:text-xl text-white/90 leading-relaxed font-light max-w-3xl border-l-2 border-steel pl-6 pt-2">
              SMT and through-hole assembly at our Hyderabad facility with box-build and IPC-A-610 workmanship
            </p>
          </div>
        </div>
        ...
        <div className="container-editorial grid grid-cols-12 gap-8 md:gap-16 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 gsap-reveal space-y-6">
            ...
            <div className="border-t border-rule/20 pt-6 space-y-4">
              <p className="text-lg md:text-xl text-black leading-relaxed font-light">
                SMT and through-hole assembly at our Hyderabad facility. Box-build and cable/harness assembly. Workmanship to IPC-A-610; in-circuit and functional testing. ISO 9001:2015-aligned QMS with full material traceability.
              </p>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-5 gsap-reveal">
            <div className="relative aspect-[16/10] w-full overflow-hidden bg-surface rounded border border-rule/10 shadow-lg">
              <img
                src={factoryHall}
                alt="Electronics Production Facility"
        ...
        <div className="container-editorial space-y-16">
          <div className="gsap-reveal space-y-4 max-w-3xl">
            ...
            <p className="text-base text-ink-muted leading-relaxed font-light">
              End-to-end electronics manufacturing capabilities at our dedicated Hyderabad production facility.
            </p>
          </div>
