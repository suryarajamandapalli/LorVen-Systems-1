...
export const Route = createFileRoute("/services/product-dev")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "End-to-end electronic product development services — from concept through validated design to production." },
    ],
  }),
    ...
    <div ref={containerRef} className="bg-bg text-ink selection:bg-ink selection:text-on-dark antialiased">
      ...
      <section className="relative min-h-screen bg-ink overflow-hidden flex flex-col justify-center pb-20 pt-28">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <img
            src={pcbMacro}
            alt="Electronic Product Development"
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2 text-white/50 text-[9px] uppercase tracking-[0.2em] font-bold select-none pointer-events-none animate-bounce">
          <span>Explore Development Lifecycle</span>
        ...
        <div className="container-editorial grid grid-cols-12 gap-8 md:gap-16 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 gsap-reveal space-y-6">
            ...
            <div className="border-t border-rule/20 pt-6 space-y-4">
              ...
              <p className="text-base text-ink-muted leading-relaxed font-light">
                LorVen Systems offers comprehensive electronic engineering services for railway and safety-critical industries. Our team manages complete product lifecycles from architecture and compliance planning to full production handover.
              </p>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-5 gsap-reveal">
            <div className="relative aspect-[16/10] w-full overflow-hidden bg-surface rounded border border-rule/10 shadow-lg">
              <img
                src={pcbMacro}
                alt="Electronic Hardware Design & Layout"
      ...
      {/* 3. Development Lifecycle Section */}
      <section className="bg-bg border-t border-rule/20 py-12 md:py-16">
        <div className="container-editorial space-y-12">
          <div className="gsap-reveal space-y-4">
            <span className="eyebrow block text-steel font-bold tracking-widest text-xs uppercase">DEVELOPMENT LIFECYCLE</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
            {stages.map((stg, idx) => (
              <div key={idx} className="flex gap-6 items-start gsap-reveal group">
                <div className="w-12 h-12 rounded-full bg-section border border-rule/20 flex items-center justify-center text-ink flex-shrink-0 font-bold text-sm group-hover:bg-steel group-hover:text-white transition-colors duration-300">
                  {stg.step}
                </div>
                <div className="space-y-2 flex-1">
                  <h3 className="text-lg font-bold text-ink uppercase tracking-wide leading-snug">{stg.title}</h3>
                  <p className="text-sm text-ink-muted leading-relaxed font-light">{stg.desc}</p>
                </div>
              </div>
            ))}
          </div>
